...
HD_PWD='D:/self_learning/RISC-V-RV32I-CPU/1/risc_v_cpu1/risc_v_cpu1.runs/inst_blkmem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inst_blkmem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inst_blkmem.tcl
